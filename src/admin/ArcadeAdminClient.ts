import type { SpriteCreateArcadeUser } from '@/admin/static/createUser.js';
import {
    adminCommand,
    closeDatabase,
    connectCluster,
 ...
 * serverReadyExample();
 */
export class ArcadeAdminClient {
  readonly #context: ArcadeAdminContext;
  constructor(context: ArcadeAdminContext) {
   ...
   * serverReadyExample();
   */
  serverReady = async (): Promise<boolean> => serverReady(this.#context);
  /**
  ...
  closeDatabase = async (databaseName: string): Promise<boolean> =>
    closeDatabase(this.#context, databaseName);
  /**
   *
  ...
  openDatabase = async (databaseName: string): Promise<boolean> =>
    openDatabase(this.#context, databaseName);
  /**
  ...
  command = async <T>(command: string): Promise<T> =>
    adminCommand(this.#context, command);
  /**
  ...
  connectCluster = async (address: string): Promise<boolean> =>
    connectCluster(this.#context, address);
  /**
   * Create a database
  ...
  createDatabase = async (databaseName: string) =>
    createDatabase(this.#context, databaseName);
  /**
   ...
   * });
   */
  createUser = async (params: SpriteCreateArcadeUser): Promise<boolean> =>
    createUser(this.#context, params);
  /**
  ...
  disconnectCluster = async (): Promise<boolean> =>
    disconnectCluster(this.#context);
  /**
   * Drop a database
  ...
  dropDatabase = async (databaseName: string): Promise<boolean> =>
    dropDatabase(this.#context, databaseName);
  /**
  ...
  dropUser = async (username: string): Promise<boolean> =>
    dropUser(this.#context, username);
  /**
   ...
   */
  getEvents = async (): Promise<ArcadeServerEvents> =>
    getServerEvents(this.#context);
  /**
  ...
  getInformation = async <M extends ArcadeServerInformationLevel = 'default'>(
    ...
    getServerInformation(this.#context, mode);
  /**
   ...
   * shutdownExample();
   */
  shutdown = async (): Promise<boolean> => serverShutdown(this.#context);
}
